...
\author{Paul Swoboda$^{\dagger,\ddagger}$, Ahmed Abbas$^\ddagger$, Florian Bernard$^{\star}$, Andrea Hornakova$^\ddagger$, Paul Roetzer$^{\star}$,\\
Bogdan Savchynskyy$^{\diamond}$}
\date{%
$^\dagger$Heinrich-Heine~Universit\"at~D\"usseldorf, %
$^\ddagger$MPI~for~Informatics,~Saarbr\"ucken, %
