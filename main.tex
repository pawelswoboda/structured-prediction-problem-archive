...
\author{Paul Swoboda$^{\circledcirc,\dagger}$, Bjoern Andres$^{\triangleleft}$, Florian Bernard$^{\star}$, Andrea Hornakova$^\dagger$, Jannik Irmai$^\triangleleft$, \\ Paul Roetzer$^{\ddagger,\star}$, Bogdan Savchynskyy$^{\diamond}$, David Stein$^\triangleleft$, Ahmed Abbas$^\dagger$}
\date{%
